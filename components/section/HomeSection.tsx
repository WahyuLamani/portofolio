          ...
          <div className="space-y-4 relative z-10">
            <div className="inline-block px-4 py-2 bg-zinc-900 border border-zinc-800 clip-corner">
              <span className="text-sm text-zinc-400">
                <span className="text-cyan-600"> ● </span> Available for
                freelance
              </span>
            </div>
            ...
            <p className="text-lg text-zinc-400 max-w-lg leading-relaxed">
              Hallo, I&lsquo;m Wahyu, as a junior full-stack developer, I enjoy
              making straightforward, practical, and user-focused web apps.
              <br />I always learn new things and improve my skills while using
              modern technology to turn ideas into reliable digital solutions.
            </p>

            <div className="flex flex-wrap gap-4">
              <a
                href="#work"
                className="px-8 py-4 bg-white text-zinc-950 font-medium clip-corner hover:bg-zinc-200 transition-all flex items-center gap-2 group"
              >
                View Projects
              ...
              <a
                href="#about"
                className="px-8 py-4 border border-zinc-700 font-medium clip-corner hover:bg-zinc-900 transition-all"
              >
                More About Me !
              </a>
            </div>
            ...
            <div className="flex gap-4 pt-4">
              {sosialMedia.map(({ icon: Icon, href }, i) => {
                ...
                return isEmail ? (
                  <MailTooltip key={i} content={mail}>
                    {link}
                  </MailTooltip>
                ) : (
                  link
