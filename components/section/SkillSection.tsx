        ...
        <div className="grid lg:grid-cols-2 gap-16">
          <div className="space-y-8">
            ...
            <p className="text-lg text-zinc-400 leading-relaxed">
              Learning and applying modern technologies to build reliable
              digital experiences, while continuously growing alongside the
            ...
            <div className="relative h-full flex items-center justify-center">
              <div className="relative w-80 h-80">
                ...
                <div className="absolute inset-16 bg-zinc-900 border border-zinc-700 rotate-45 flex items-center justify-center">
                  <div className="text-6xl font-bold text-zinc-800 -rotate-45">
                    +6
                  </div>
                </div>
